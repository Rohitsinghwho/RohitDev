...
const Contact = () => {
  ...
  <p className="text-xs sm:text-sm font-semibold text-slate-900 mb-1">Email</p>
  <a 
  ...
  >
    developmentbyrohit@gmail.com
                ...
                <div className="flex items-start gap-3 sm:gap-4 mb-4 sm:mb-6 p-3 sm:p-4 hover:bg-slate-50 rounded-xl transition-all duration-200">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-xs sm:text-sm font-semibold text-slate-900 mb-1">Phone</p>
                    <p className="text-slate-700 font-medium text-sm sm:text-base">+91 7668266134</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 hover:bg-slate-50 rounded-xl transition-all duration-200">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-xs sm:text-sm font-semibold text-slate-900 mb-1">Location</p>
                    <p className="text-slate-700 font-medium text-sm sm:text-base">Dehradun, Uttarakhand, India</p>
                  </div>
                </div>

                {/* Social Links */}
                <div className="mt-6 sm:mt-8 pt-6 sm:pt-8 border-t border-slate-200">
                  <h3 className="text-base sm:text-lg font-semibold text-slate-900 mb-4 text-center sm:text-left">Connect on Social</h3>
                  <div className="flex gap-2 sm:gap-3 justify-center sm:justify-start">
                    <a href="https://github.com/rohitsinghwho" target="_blank" className="w-10 h-10 sm:w-12 sm:h-12 bg-slate-100 hover:bg-slate-200 rounded-lg sm:rounded-xl flex items-center justify-center text-slate-700 hover:text-slate-900 hover:scale-105 transition-all duration-200 shadow-sm hover:shadow-md">
                      <Github size={16} className="sm:w-5 sm:h-5" />
                    </a>
                    <a href="https://linkedin.com/in/rohitsinghwho" target="_blank" className="w-10 h-10 sm:w-12 sm:h-12 bg-slate-100 hover:bg-blue-50 rounded-lg sm:rounded-xl flex items-center justify-center text-slate-700 hover:text-blue-600 hover:scale-105 transition-all duration-200 shadow-sm hover:shadow-md">
          ...
          <div className="order-1 lg:order-2">
            <Card className="w-full bg-white/80 backdrop-blur-sm border-slate-200 shadow-xl hover:shadow-2xl transition-shadow">
              <CardContent className="pt-6 sm:pt-8 pb-6 px-4 sm:px-6">
                ...
                {status && (
                  <div className={`p-3 sm:p-4 rounded-lg sm:rounded-xl mb-6 font-medium text-xs sm:text-sm ${
